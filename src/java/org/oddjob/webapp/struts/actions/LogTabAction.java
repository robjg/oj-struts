...
/**
 * The Struts Action which handles the log tab.
 *  
 * @author Rob Gordon.
 */
public class LogTabAction extends Action {
	private static final Logger logger = Logger.getLogger(LogTabAction.class);
	...
	throws Exception {
		...
		logger.debug("Retrieving log for [" + detailForm.getRefId() + "]" );
